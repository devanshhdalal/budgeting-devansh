...
export default function Stepper({
  ...
  const goToStep = (clicked) => {
    if (clicked === currentStep || disableStepIndicators) return;
  ...
  return (
    <div className="stepper-outer" {...rest}>
      <div className={`stepper-shell glass-panel ${stepCircleContainerClassName}`}>
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: 'var(--border-strong)', color: 'var(--text-faint)' },
